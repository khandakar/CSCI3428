...
appAPI.ready(function($) { // put all code within the ready scope
	...
	var shieldImage="resource-image://favicon.png"; // resource-image://logo32_32.png 32 x 32 pixel
	...
	var searchBoxFontColor="black";//"//"white"; // was black before #862633
	...
	var noFrameShown=0; // detect if a frame is on the page 
	...
	/*
		checks to see if the recent bms and search bar can be
		displayed.
		if not, it hides them. recent bms first, then search.
	 */
	function resizeNow()
	{
